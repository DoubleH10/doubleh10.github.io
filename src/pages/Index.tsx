  ...
  const experiences = [
    ...
    },
    {
      ...
      highlights: [
        ...
        "Mentored junior engineers on ADK/LangGraph architecture",
      ],
    },
    {
      company: "Ekimetrics",
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <a
              href="mailto:hijazi.hadi@gmail.com"
              className="flex items-center gap-2 hover:text-foreground transition-colors"
            >
                ...
                <div className="flex flex-wrap gap-2">
                  {items.map((skill, idx) => (
                    ...
                    >
                      <Badge
                        variant="outline"
                        className="text-sm px-3 py-1 border-border hover:border-accent hover:text-accent transition-all cursor-default"
                      >
                        {skill}
                      </Badge>
                    </motion.div>
